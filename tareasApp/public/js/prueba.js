...
describe("Pruebas agregar", function () {
    it("Agregar tarea completa", function () {
        ...
        let titulo = "Tarea 1";
        let descripcion = "Tarea 1 para probar la funcionalidad del model";
        ...
        assert.equal(tareasApp.tareas[0]._descripcion, 'Tarea 1 para probar la funcionalidad del model');
